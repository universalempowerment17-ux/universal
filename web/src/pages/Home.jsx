    ...
    <>
      ...
      <section className="section-pad mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_18px_45px_rgba(15,23,42,0.05)]">
            {featureImageUrl ? (
              <img
                src={featureImageUrl}
                alt="Community work"
              ...
              <div className="flex h-96 items-end rounded-2xl bg-slate-50 p-6 text-slate-700">
                <div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 leading-relaxed text-slate-700">
                ...
                <p className="rounded-2xl border-l-4 border-accent bg-surface p-5 text-slate-700">
      ...
      <section className="section-pad mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-10 grid items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {interventions.map((item) => (
            <div
              key={item.title}
              className="group flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_18px_35px_rgba(15,23,42,0.08)]"
            >
      ...
      <section className="section-pad bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          {shouldAutoRotateStories ? (
            <div className="mt-10 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-[0_18px_45px_rgba(15,23,42,0.04)]">
              <div
